...
namespace mab
{
	...
	*/
	...
	private:
		...
		// virtual Bus *createUsb(const std::string idVendor, const std::string idProduct, std::vector<mab::Candle *> instances) { return new UsbDevice(idVendor, idProduct, instances); }
	};
